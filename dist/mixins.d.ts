...
declare function Augment<A extends Arr, C1, S1, C2, S2>(c1: Class<A, C1, S1>, c2: Class<A, C2, S2>): Class<A, C1 & C2, S1 & S2>;
/**
...
*/
declare const base: (...ingredients: Class<any[], {}, {}>[]) => (decoratedClass: any) => any;
